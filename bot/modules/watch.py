...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg = f"/{BotCommands.WatchCommand} [youtube-dl supported link] [quality] |[CustomName] untuk mirror dengan youtube-dl.\n\n"
        msg += "<b>Catatan: Kualitas dan nama kustom adalah opsional</b>\n\nContoh kualitas: audio, 144, 240, 360, 480, 720, 1080, 2160."
        msg += "\n\nJika Anda ingin menggunakan nama file khusus, masukkan setelahnya |"
        msg += f"\n\nContoh:\n<code>/{BotCommands.WatchCommand} https://youtu.be/hONY8nxk8gc 720 |Kucing</code>\n\n"
        msg += "File ini akan diunduh dalam kualitas 720p dan namanya adalah <b>Kucing</b>"
